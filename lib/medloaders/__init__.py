...
from .miccai_2018_brain_tumor import MICCAI2018BrainTumor
...
def generate_datasets(args, path='.././datasets'):
    ...
    if args.dataset_name == "iseg2017":
    ...
    elif args.dataset_name == "miccai2018":
        total_data = 484
        split_idx = int(split_percent * total_data) - 1

        train_loader = MICCAI2018BrainTumor(args, 
                                            mode='train', 
                                            dataset_path=path,
                                            crop_dim=args.dim, 
                                            split_idx=split_idx, 
        ...
        val_loader = MICCAI2018BrainTumor(args,
                                        mode='val',
                                        dataset_path=path,
                                        crop_dim=args.dim,
                                        split_idx=split_idx,
