...
from torchio.transforms.transform import TypeTripletInt, TypeSixBounds
...
class RandomCropOrPad(BoundsTransform):
    ...
    def _compute_mask_center_crop_or_pad(
        ...
        for dim in range(3):
            ...
            begin = center_dim - randint(0, target_dim//2)
            ...
            print("pad : ", pad_ini, pad_fin, "\t crop : ", crop_ini, crop_fin)
